...
const Physics = (props, navigation) => {
  ...
  const submitPress = () => {
    props.navigation.navigate('Subbranch');
  };
                    ...
                    <View>
                      <View
                        ...
                        <View style={{flexDirection: 'row'}}>
                          ...
                          <View style={{marginLeft: 10, top: -3}}>
                            <ImageBackground
                              source={HALF_MULTICOLOR}
                              resizeMode="contain"
                              style={{
                            ...
                            <View style={{flexDirection: 'row'}}>
                              <View>
                                <Text
                                  ...
                                  Newton of Law of Motion
                                </Text>
                                <Text style={{color: '#c2c2c2', fontSize: 15}}>
                                  0/0 Unique card studied
                                </Text>
